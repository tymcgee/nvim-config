...
vim.opt.undofile       = true                               -- Do use an undofile
vim.opt.undolevels     = 10000                              -- Use lots of undo levels
...
vim.opt.splitkeep      = "screen" -- Scroll behavior when managing splits
