return {
    ...
    keys = {
        ...
        { "<leader>sl", function() Snacks.picker.lazy({layout = {preset = "vscode"}}) end, desc = "Plugin specs" },
        { "<leader>sk", function() Snacks.picker.keymaps({layout = {preset = "vscode"}}) end, desc = "Keymaps" },
        ...
        { "<leader>sH", function() Snacks.picker.highlights({layout = {preset = "vscode"}}) end, desc = "Highlights" },
        ...
        { "gr", function() Snacks.picker.lsp_references({layout = {preset = "bottom"}}) end, nowait = true, desc = "References" },
